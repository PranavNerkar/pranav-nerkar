        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center md:text-left">
              <div className="w-64 h-64 mx-auto md:mx-0 rounded-full bg-gradient-to-r from-primary to-blue-700 flex items-center justify-center mb-6 overflow-hidden shadow-lg">
                ...
                <span className="text-white text-6xl font-bold hidden">PN</span>
              </div>
            </div>
