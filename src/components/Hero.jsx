    ...
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 pt-20">
      <div className="container-custom text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="w-32 h-32 mx-auto mb-8 rounded-full bg-gradient-to-r from-primary to-blue-700 flex items-center justify-center">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-6">
            Hi, I'm{' '}
            <span className="text-primary">Pranav Nerkar</span>
          </h1>
